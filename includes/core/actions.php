...
add_action('woocommerce_cart_totals_after_order_total', 'mostrar_total_en_dolares');
add_action('woocommerce_review_order_after_order_total', 'mostrar_total_en_dolares');
